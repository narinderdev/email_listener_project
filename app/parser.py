...
def parse_email_content(mail):
    ...
    # 1. Extract Customer Rep
    rep_match = re.search(r"Customer\s*Rep:\s*(.*)", body)
    ...
    # 3. Phone numbers
    phone_matches = re.findall(r"Phone:\s*(\d+)", moving_from_section)
    ...
    # Extract Customer Payment amount
